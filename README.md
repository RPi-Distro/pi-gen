# Dependencies
    ...
    sudo apt-get update && sudo apt-get install git curl quilt kpartx realpath qemu-user-static debootstrap zerofree pxz zip dosfstools bsdtar libcap2-bin -y && cd ../ &&
